    ...
    <div className='flex items-center justify-between text-sm py-5 mb-5 border-b  border-b-gray-400 '>
      ...
      <div className='flex items-center  gap-4'>
      {
        token ? <div className='flex items-center gap-2 cursor-pointer  group relative'>
          ...
          <div className='absolute top-0 right-0 pt-15 text-sm font-medium text-gray-600 z-20 hidden group-hover:block'>
       ...
       : <button onClick={()=>navigate('/login')} className= ' bg-blue-600 text-white px-8 py-3 rounded-null font-light hidden md:block'>Create Account</button>
      }
      </div>
    </div>
  )
