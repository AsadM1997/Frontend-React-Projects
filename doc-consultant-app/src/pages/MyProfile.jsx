    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm ' >
      ...
      <div>
        ...
        <div>
          <p>Gender:</p>
          {isEdit
            ? <select onChange={(e) => setUserData(prev => ({ ...prev => ({ ...prev, gender: e.target.value }) }))} value={userData.gender}>
          ...
          {
            isEdit
              ? <input type='date' onChange={(e) => setUserData(prev => ({ ...prev => ({ ...prev, dob: e.target.value }) }))} value={userData.dob} />
              : <p>{userData.dob}</p>
          }
        </div>
      </div>
